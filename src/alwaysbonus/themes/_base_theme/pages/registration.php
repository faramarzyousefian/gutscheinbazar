...
<div class="work_bottom1">
		...
		<tr>
		<td align="right" valign="top"><label><?php echo $language['first_name']; ?></label></td>
		<td><input type="text" class="input_box required" name="firstname" id="firstname" title="<?php echo $language['valid_firstname']; ?>" /></td>
		</tr>

		<tr>
		<td align="right" valign="top"><label><?php echo $language['last_name']; ?></label></td>
		<td><input type="text" class="input_box required" name="lastname" id="lastname" title="<?php echo $language['valid_lastname']; ?>" /></td>
		</tr>
		...
		<tr>
		<td align="right" valign="top"><label><?php echo $language['mobile']; ?></label></td>
