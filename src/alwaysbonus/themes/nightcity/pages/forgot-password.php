...
if($_POST)
{
	...
	if($email==$language['valid_email']){

			set_response_mes(-1,$language['valid_email']);
...
<div class="work_bottom ">
  <form action="" name="login" id="login" method="post">
    <table width="100%" border="0" cellpadding="5" cellspacing="5" class="contact_user">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div class="fl clr"> <span class="submit">
            <input type="submit" class="bnone" value="<?php echo $language['post']; ?>" name="submit" />
            </span> </div></td>
      </tr>
    </table>
  </form>
